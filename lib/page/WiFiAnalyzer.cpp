...
bool WiFiAnalyzer::matchBssidPrefix(uint8_t *a, uint8_t *b)
{
...
void WiFiAnalyzer::initWiFiAnalyzer()
{
...
void WiFiAnalyzer::wiFiAnalyzerLoop()
{
...
void WiFiAnalyzer::draw()
{
    wiFiAnalyzerLoop();
}

void WiFiAnalyzer::update()
{
    wiFiAnalyzerLoop();
}

void WiFiAnalyzer::init()
{
    initWiFiAnalyzer();
}

void WiFiAnalyzer::exit()
{
}

void WiFiAnalyzer::loop()
{
    wiFiAnalyzerLoop();
}